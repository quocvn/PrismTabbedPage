...
{
    public class CollapsePageViewModel
    {
        public List<ImageSetting> ImageSettings { get; private set; }
        public List<ImageList> Images { get; private set; }
        public List<Monkey> Monkeys { get; private set; }

        public CollapsePageViewModel()
        {
            InitCollection();
            //InitMonkey();
        }
        ...
        {
            ImageSettings = new List<ImageSetting>
            {
                new ImageSetting
                {
                    SettingName = "Animal",
                    Images = new List<ImageList>
                    {
                        ...
                        {
                            Name = "A",
                            Url = "https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Capuchin_Costa_Rica.jpg/200px-Capuchin_Costa_Rica.jpg"
                        },
                        new ImageList
                        {
                            Name = "B",
                ...
                new ImageSetting
                {
                    ...
                    Images = new List<ImageList>
                    {
                        ...
                        {
                            Name = "E",
                            Url = "https://via.placeholder.com/150/92008c"
                        },
                        new ImageList
                        {
                            Name = "F",
                            Url = "https://via.placeholder.com/150/ff5757"
                        },
                        new ImageList
                        {
                            Name = "G",
                            Url = "https://via.placeholder.com/150/218766"
                        },
                        new ImageList
                        {
                            Name = "H",
                            Url = "https://via.placeholder.com/150/ff9c38"
                        }
                    }
                }
            };
